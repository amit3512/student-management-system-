<ul class="sidebar navbar-nav">
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu" aria-labelledby="pagesDropdown">
        <h6 class="dropdown-header">Login Screens:</h6>
        <a class="dropdown-item" href="{{ url('/nursery') }}">Nursery</a>
        <a class="dropdown-item" href="{{ url('/lkg') }}">LKG</a>
        <a class="dropdown-item" href="{{ url('/ukg') }}">UKG</a>
        <div class="dropdown-divider"></div>
        <h6 class="dropdown-header">One</h6>
         <a class="dropdown-item" href="{{ url('/1') }}">One</a>
        <a class="dropdown-item" href="{{ url('/2') }}">Two</a>
        <a class="dropdown-item" href="{{ url('/3') }}">Three</a>
